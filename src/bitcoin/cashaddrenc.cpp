...
const CChainParams TestNetChainParams    = { "ctwotest" },
                   TestNet4ChainParams   = { "ctwotest" },
                   ScaleNetChainParams   = { "ctwotest" },
                   RegTestNetChainParams = { "ctworeg" },
                   MainNetChainParams    = { "ctwo" };
